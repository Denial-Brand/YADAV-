...
\033[1;37m----------------------------------------------
 GITHUB NAME    : BRAND-DANIEL
 FACEBOOK  NAME : DANIEL BRAND 
...
def contact():
	clear()
	banner()
	print(" [\u001b[36m1\033[1;37m] BRAND-DANIEL")
	print(" [https://www.facebook.com/profile.php?id=100080983368779")
	linex()
	admin = input(" CHOOSE : ")
	if admin in ['1']:
